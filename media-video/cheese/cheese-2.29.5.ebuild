...
RDEPEND="${COMMON_DEPEND}
	...
	>=media-plugins/gst-plugins-ogg-0.10.23
	>=media-plugins/gst-plugins-pango-0.10.23
	>=media-plugins/gst-plugins-theora-0.10.23
	>=media-plugins/gst-plugins-v4l2-0.10
	>=media-plugins/gst-plugins-vorbis-0.10.23
